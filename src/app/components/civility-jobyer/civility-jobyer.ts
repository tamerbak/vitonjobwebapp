...
export class CivilityJobyer{
  ...
  //numSS, cni, nationalityId,  birthdate, birthdepId, birthplace, birthCountryId, numStay,
  ...
  getData(){
    console.log("doeee");
      ...
      this.onSendData.emit({numSS:this.numSS,cni:this.cni,nationalityId:this.nationalityId,birthdate:'',birthdepId:this.birthdepId,
   ...
   init(){
     if (!this.currentUser.isNewUser)
       this.profileService.loadAdditionalUserInformations(this.currentUser.jobyer.id).then((data: any) => {
         ...
         console.log(this.dateStay,this.dateFromStay,this.dateToStay)


// if ((<HTMLInputElement>document.getElementById("dateStay")) != null){
//   (<HTMLInputElement>document.getElementById("dateStay")).value = dataStay;
// }
// if ((<HTMLInputElement>document.getElementById("dateFromStay")) != null){
//   (<HTMLInputElement>document.getElementById("dateFromStay")).value = "1999-07-07";
// }
// if ((<HTMLInputElement>document.getElementById("dateToStay")) != null){
//   (<HTMLInputElement>document.getElementById("dateToStay")).value = dateToStay;
// }

  console.log((<HTMLInputElement>document.getElementById("dateStay")),(<HTMLInputElement>document.getElementById("dateFromStay")),(<HTMLInputElement>document.getElementById("dateToStay")))



         console.log(this.regionId,this.dateFromStay,this.dateToStay,this.dateFromStay)
         if (this.regionId == '40') {
           this.isFrench = true;
