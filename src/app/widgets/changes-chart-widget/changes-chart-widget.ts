...
@Component({
  ...
  template: require('./changes-chart-widget.html'),
  directives: [RickshawChart, JqSparkline],
...
export class ChangesChartWidget {
  ...
  applyRickshawData(): void {
    ...
    this.series = [{
      ...
      name: 'humidity',
      data: seriesData.shift().map(function(d): Object { return { x: d.x, y: d.y * (Math.random() * 0.1 + 1.1) }; }),
      renderer: 'line',
      /* tslint:disable */
