...
import {MapaelLayersMap} from '../../components/mapael/mapael';
declare var jQuery: any;

@Component({
  selector: '[years-map-widget]',
  template: require('./years-map-widget.html'),
  directives: [MapaelLayersMap],
})
...
export class YearsMapWidget {
  ...
  constructor (config: ConfigService, fakeWorld: FakeWorldData) {
